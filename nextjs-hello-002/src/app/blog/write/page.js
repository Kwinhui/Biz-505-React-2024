...
export default () => {
  ...
  return (
    <form className={styles.form} action={actionHandler} method="POST">
      <input placeholder="카테고리" name={FORM_NAME.CATEGORY} />
      <input placeholder="제목" name={FORM_NAME.SUBJECT} />
      <textarea placeholder="내용" rows="20" name={FORM_NAME.CONTENT} />
      <input className={styles.submit} type="submit" value="저장하기" />
    </form>
  );
};
